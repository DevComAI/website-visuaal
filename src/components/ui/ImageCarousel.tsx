  ...
  return (
    <div className="relative w-full  mx-auto">
      ...
      <button
        ...
        className="absolute left-0 top-1/2 -translate-y-1/2 z-20 bg-white/80 hover:bg-white text-black p-3 rounded-full transition-colors duration-200"
      ...
      <button
        onClick={goToNext}
        className="absolute right-0 top-1/2 -translate-y-1/2 z-20 bg-white/80 hover:bg-white text-black p-3 rounded-full transition-colors duration-200"
